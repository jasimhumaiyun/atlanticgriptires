      ...
      <div className="container-custom relative z-10">
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] xl:gap-20">
          ...
          >
            ...
            >
              <button
                ...
                className="bg-gradient-red text-white transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_30px_120px_rgba(220,38,38,0.35)] rounded-full px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-semibold cursor-pointer text-center"
              >
                Book Appointment
              </button>
              <button
                onClick={() => scrollToSection('services')}
                className="rounded-full border border-white/20 px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-semibold text-white transition-all duration-300 hover:-translate-y-1 hover:border-primary hover:bg-primary/10 cursor-pointer text-center"
              >
                View Services
              </button>
            </motion.div>
          ...
          <motion.div
            ...
            className="relative flex items-center justify-center mt-6 sm:mt-8 lg:mt-0"
